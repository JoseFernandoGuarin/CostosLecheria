...
Los logos institucionales utilizados pertenecen a la Universidad de Antioquia y a su Facultad de Ciencias Agrarias, con fines académicos e institucionales.
...
No se requiere backend ni base de datos para la versión actual.
...
│   └── img/
│       ├── udea.png        # Logo Universidad de Antioquia
│       └── facultad.png    # Logo Facultad de Ciencias Agrarias
